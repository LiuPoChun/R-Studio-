...
```{r}
round(125.78543)
round(125.78543, digits = 2)
round(125.78543, digits= -2)
round(12578543, digits= -4)
signif(125.78543, digits =2)
signif(12578543, digits =2)
floor(125.78543)
ceiling(125.78543)
trunc(125.78543) #Extract the integer part
```
...
```{r}
#Way3  
#Use: ifelse(condition, commands when TRUE, commands when FALSE)
